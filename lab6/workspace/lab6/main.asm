...
find_more:	
	push ECX                ; konvencia stdcall dovoluje vole modifikovat registre ECX, EDX, EAX
	                        ; v tele podprogramu. ECX pouzivame ako counter a tak si ho musime
	                        ; pred volanim procedury ulozit         
	
	push EDI     		    ; zavolanie procedury findstr - druhy parameter
	push ESI	            ; - prvy parameter
	call findstr            ; - volanie           
	
	pop ECX                 ; po navrate z procedury si obnovime ECX
	cmp EAX, -1
	je t3_end
	...
	;_iwriteln ECX			; print out the counter
	mov [buffer + ECX], AL
