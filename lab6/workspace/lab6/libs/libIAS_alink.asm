...
_string msg_EOL, EOL
_string msg_EnterChar, 'Zadejte znak: '
_string msg_EnterUInt, 'Zadejte cele cislo bez znamenka z intervalu <%u,%u>: '
_string msg_EnterSInt, 'Zadejte cele cislo se znamenkem z intervalu <%d,%d>: '
_string msg_EnterFloat, 'Zadejte realne cislo (napr. 1.5): '
_string msg_EnterString, 'Zadejte text (maximum je %d znaku): '
_string msg_NumberTooBig, 'Cislo je prilis velke, vracim maximalni moznou hodnotu.', EOL
_string msg_NumberTooLow, 'Cislo je prilis male, vracim minimalni moznou hodnotu.', EOL
